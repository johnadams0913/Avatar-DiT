...
class Options():
    ...
    def initialize(self, eval=False):
        ...
        self.parser.add_argument('--num_threads', '-nt', type=int, default=8,
    ...
    def add_training_options(self):
        ...
        self.parser.add_argument('--lr_guidance', default=8e-6, type=float,
                                 help="Learning rate for guidance network (fake score estimator)")
        self.parser.add_argument('--beta1', type=float, default=0.0,
                                 help='Adam beta1 (0.0 disables momentum, better for adversarial-style training)')
        self.parser.add_argument('--beta2', type=float, default=0.999,
                                 help='Adam beta2')
        self.parser.add_argument('--beta1_guidance', type=float, default=0.0,
                                 help='Adam beta1 for guidance optimizer')
        self.parser.add_argument('--beta2_guidance', type=float, default=0.999,
                                 help='Adam beta2 for guidance optimizer')
        self.parser.add_argument('--weight_decay', type=float, default=0.01,
                                 help='AdamW weight decay')
        self.parser.add_argument('--gen_update_freqs', '-guf', default=5, type=int,
                                 help='Frequency of updating the generator in DMD distillation')
        ...
        self.parser.add_argument('--precision', choices=["fp8", "bf16", "fp16", "fp32"], default="bf16",
        ...
        self.parser.add_argument('--save_freq_step', '-sfs', type=int, default=2000,
    ...
    def add_testing_options(self):
        ...
        self.parser.add_argument('--save_concat', '-sc', action='store_true',
                                 help='Save concatenated video')
        self.parser.add_argument('--use_reference_folder', '-urf', action='store_true',
                                 help='Use reference folder')
        self.parser.add_argument('--output_dir', '-o', type=str, default=None,
                                 help='Output directory')
        self.parser.add_argument('--fps', '-fps', type=int, default=30,
